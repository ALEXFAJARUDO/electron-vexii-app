...
const ORDER_MENU: Record<string, OrderItem[]> = {
  menu01: [
    { id: 101, name: '白雲台コース',       desc: '一人前',  price: 5000,  photo: '🍽', photoBg: 'linear-gradient(135deg,#b45309,#92400e)', photoUrl: `${HP}img_menu02.jpg`, tag: '人気' },
  ...
  menu02: [
    ...
    { id: 205, name: '特撰厚切り牛タン',    desc: '厚切りでジューシー',   price: 3000,  photo: '🥩', photoBg: 'linear-gradient(135deg,#d97706,#b45309)', photoUrl: `${HP}img_yaki05.jpg` },
    ...
    { id: 207, name: '上撰バラ',            desc: 'とろける上質なバラ肉', price: 1800,  photo: '🥩', photoBg: 'linear-gradient(135deg,#b45309,#92400e)' },
    { id: 208, name: '上撰骨付きカルビ',    desc: '骨付きで旨みが凝縮',   price: 2100,  photo: '🥩', photoBg: 'linear-gradient(135deg,#b91c1c,#991b1b)' },
    ...
    { id: 220, name: '骨付きカルビ',        desc: '骨付きカルビ・甘口たれ', price: 1400, photo: '🥩', photoBg: 'linear-gradient(135deg,#b91c1c,#991b1b)', photoUrl: `${HP}img_yaki05.jpg`, tag: '人気' },
    { id: 221, name: '中落ちカルビ',        desc: 'ジューシーな中落ちカルビ', price: 1000, photo: '🥩', photoBg: 'linear-gradient(135deg,#b45309,#92400e)', photoUrl: `${HP}img_yaki06.jpg` },
    ...
    { id: 224, name: '上ミノ',              desc: '第一胃・コリコリ食感', price: 950,   photo: '🐄', photoBg: 'linear-gradient(135deg,#0284c7,#0369a1)', photoUrl: `${HP}img_horumon01.jpg`, tag: '人気' },
    ...
    { id: 229, name: '焼きレバー',          desc: '新鮮レバー・ごまだれ', price: 800,   photo: '🐄', photoBg: 'linear-gradient(135deg,#9d174d,#831843)', photoUrl: `${HP}img_horumon03.jpg` },
